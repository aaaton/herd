...
//             return color;
    ...
    var embed = function(container, collData, docData, webFontURLs) {
          ...
          $.each($.extend({}, docData.entity_types), function(value) {
                 spanTypes[value.type] = value;
          });

            /*var spanTypes = docData.entity_types {
                SPAN_DEFAULT: {"borderColor": "darken", "arrowHead": "triangle,5", "name": "SPAN_DEFAULT", "color": "black", "labels": null, "unused": true, "bgColor": "lightgreen", "type": "SPAN_DEFAULT", "fgColor": "black"}
            }*/

          var commentPopup = $('#commentpopup');
          var commentDisplayed = false;

          var displayCommentTimer = 1000;
